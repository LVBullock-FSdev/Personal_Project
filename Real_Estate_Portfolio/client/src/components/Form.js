...
const Form = (props) =>{
  ...
  const fileSelectedHandler = (e) => {
   ...
   const uploadHandler = async (e) => {
    ...
    formData.append("images", images.name);
    ...
    //   console.log(`${ selectedFile }, File uploaded successfully!`);
    // }
        ...
        <div className="container">
            ...
            <div className="formLeft">
                ...
                <div className="horizontalAlignmentImages">
                    ...
                    <button className="uploadBtn" onClick={uploadHandler} style={{height: "30px", color: "white"}}>Upload</button>
